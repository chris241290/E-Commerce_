...
import com.app.service.interfaces.AddressService;
...
public class AddressServiceImpl implements AddressService {
	...
	public AddressDTO createAddress(AddressDTO addressDTO) {
		...
		Address addressFromDB = addressDAO.findByCountryAndStateAndCityAndPincodeAndStreetAndBuildingName(country,
	...
	public AddressDTO updateAddress(Long addressId, Address address) {
		Address addressFromDB = addressDAO.findByCountryAndStateAndCityAndPincodeAndStreetAndBuildingName(
