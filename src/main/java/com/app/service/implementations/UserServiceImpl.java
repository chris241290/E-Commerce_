...
import com.app.repository.RoleDAO;
...
public class UserServiceImpl implements UserService {
	...
	public UserDTO registerUser(UserDTO userDTO) {
		...
		try {
			...
			Role role = roleDAO.findById(AppConstants.USER_ID).get();
			...
			Address address = addressDAO.findByCountryAndStateAndCityAndPincodeAndStreetAndBuildingName(country, state,
	...
	public UserResponse getAllUsers(Integer pageNumber, Integer pageSize, String sortBy, String sortOrder) {
		...
		Page<User> pageUsers = userDAO.findAll(pageDetails);
